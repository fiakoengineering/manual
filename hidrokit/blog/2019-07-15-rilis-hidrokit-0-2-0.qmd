...
Baca [abstrak dan tujuan hidrokit](https://hidrokit.github.io/hidrokit/tentang-hidrokit) untuk informasi lebih lanjut.
...
- **Daftar tutorial fungsi/modul pada hidrokit dapat dilihat di** [**halaman ini**](https://hidrokit.github.io/notebook/kumpulan-notebook#hidrokit-).
...
- [hidrokit.github.io/hidrokit]\: Situs resmi proyek hidrokit yang berisikan dokumentasi berupa tentang hidrokit (tujuan/abstrak), tutorial/panduan berkontribusi, dll. 
- [hidrokit.github.io/notebook]\: Situs pelengkap yang berisikan kumpulan jupyter notebook mengenai penggunaan hidrokit dan pemanfaatan python dalam bidang hidrologi.
...
<img src="https://github.com/hidrokit/hidrokit/blob/gh-pages/assets/images/presskit/hidrokit-800x200-transparent.png?raw=true" class="figure-img img-fluid rounded" height="50%" width="50%" alt="Logo Hidrokit">
...
[tentang-hidrokit]: https://hidrokit.github.io/hidrokit/tentang-hidrokit
[berkontribusi]: https://hidrokit.github.io/hidrokit/berkontribusi
[kode-etik]: https://hidrokit.github.io/hidrokit/berkontribusi/kode-etik
[instalasi]: https://hidrokit.github.io/hidrokit/panduan/instalasi
[penggunaan]: https://hidrokit.github.io/hidrokit/panduan/penggunaan
[sumber]: https://hidrokit.github.io/hidrokit/serbaneka/sumber
...
[kumpulan-notebook]: https://hidrokit.github.io/notebook/kumpulan-notebook
[mengunggah-notebook]: https://hidrokit.github.io/notebook/panduan/mengunggah-notebook
[lisensi-notebook]: https://hidrokit.github.io/notebook/panduan/lisensi-notebook 
[pull-request]: https://hidrokit.github.io/notebook/panduan/pull-request
[tambah-notebook]: https://hidrokit.github.io/notebook/panduan/tambah-notebook
[unduh-notebook]: https://hidrokit.github.io/notebook/panduan/unduh-notebook

## Berkontribusi

Seluruh yang disebutkan pada proyek ini berupa paket python hidrokit, situs hidrokit, situs Hidrokit Notebook, situs readthedocs bersifat _open-source_ sehingga Anda bisa mengajukan perubahan, berkontribusi, atau bahkan Anda bisa mengembangkannya sebagai proyek Anda sendiri. Karena seluruh proyek ini menggunakan [**MIT License**](https://choosealicense.com/licenses/mit/) dan [**CC-BY-4.0**](https://choosealicense.com/licenses/cc-by-4.0/) kecuali disebutkan secara terpisah seperti pada [notebook](https://hidrokit.github.io/notebook/panduan/lisensi-notebook).

Panduan umum untuk berkontribusi dapat dibaca pada halaman [berkontribusi](https://hidrokit.github.io/hidrokit/berkontribusi).
...
[hidrokit.github.io/hidrokit]: https://taruma.github.io/hidrokit
[hidrokit.github.io/notebook]: https://taruma.github.io/hidrokit-nb
