...
Untuk mensitasi artikel ini dalam makalah formal, disarankan mensitasi makalah "Pengembangan Aplikasi Pengolahan Data Hujan Berbasis Web" dari [prosiding PIT HATHI ke-39](https://hathi.id/pit39-hathi/#tab-915) (Makalah di Jilid 5). Jika ingin mengutip halaman ini secara spesifik, dapat menggunakan sitasi yang tersedia [di akhir halaman](#sitasi) (mensitasi halaman ini).  
:::
