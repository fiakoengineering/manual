...
Pada lembar [SINGLE_SUMMARY]{.sheet-explore} tidak memiliki sel input dan untuk mengubah variabel yang dipilih bisa menggunakan objek _scroll_ atau klik panah atas atau bawah. Eksplorasi dapat dilihat di @fig-post-09.
...
Dari cara penggunaan yang disampaikan di bagian [PENGGUNAAN]{#sec-tutorial} dapat disimpulkan bahwa lembar yang terlampir ini belum dapat digunakan dalam pengambilan keputusan dan masih perlu diolah lagi lebih lanjut. Sehingga, penambahan lembar lainnya oleh pengguna sangat disarankan untuk memperoleh informasi yang dibutuhkan. 
