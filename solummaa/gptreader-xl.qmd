...
<details>
<summary>Penjelasan Tiap Komponen</summary>
...
Sel input [AXIS]{.cell-input} dan [COLUMN ID]{.cell-input} menentukan _cross tabulation_ yang akan ditampilkan di **CROSSTAB TABLE**.
