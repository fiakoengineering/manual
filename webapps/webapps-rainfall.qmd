...
%%| fig-cap: _Sequence diagram_ penggunaan ketiga aplikasi.
%%| fig-width: 100%
%%| fig-align: center
...
Ketiga aplikasi ini jauh dari sempurna masih banyak yang bisa diperbaiki dan dikembangkan lagi untuk membuat aplikasi yang memudahkan ahli hidrologi memperoleh analisis lebih cepat. Berikut kekurangan atau batasan aplikasi pengolahan data hujan:

1. Tidak adanya pengujian otomasi untuk setiap fungsi yang tersedia di aplikasi.
...
Selain kekurangan atau batasan tersebut, terdapat juga beberapa kekurangan/batasan yang diketahui untuk masing-masing aplikasi.
...
Aplikasi pengolahan data hujan yang terdiri dari: 1. _Rainfall Stations Explorer_ (`fiako-stations`); 2. _Rainfall Data Explorer_ (`hidrokit-rainfall`); 3. _Frequency Analysis_ (`fiako-anfrek`), mampu membantu mempercepat proses analisis hidrologi tanpa mengorbankan akurasi dan mengurangi kekeliruan. 
