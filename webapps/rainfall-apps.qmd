...
::: {.callout-note}
## Perbedaan artikel ini dengan makalah PIT HATHI ke-39
...
Artikel ini ditujukan sebagai penjelasan lebih detail dengan penyampaian informal dan bukan sebagai pengganti makalah yang dipublikasikan di PIT HATHI ke-39. Harapannya, artikel ini memudahkan pengguna atau _developer_ untuk berkontribusi maupun mengembangkan aplikasi yang serupa. Karena tidak ada batasan halaman pada artikel, informasi yang disampaikan bisa sejelas mungkin. 
...
![_Rainfall Stations Explorer_<br>(`fiako-stations`)](img/manual-rainfall-apps-fiako-stations.gif){width="500"}
...
![_Rainfall Data Explorer_<br>(`hidrokit-rainfall`)](img/manual-rainfall-apps-hidrokit-rainfall.gif)
...
: Tabel informasi `hidrokit-rainfall`
...
![_Frequency Analysis_<br>(`fiako-anfrek`)](img/manual-rainfall-apps-fiako-anfrek.gif)
...
: Tabel informasi `fiako-anfrek`

## Informasi Teknis Aplikasi

Pengembangan aplikasi ini dibangun menggunakan bahasa pemrograman _Python_. Berikut daftar _dependencies_ yang digunakan dalam pengembangan aplikasi. 
...
: _Packages_ yang digunakan dalam pengembangan aplikasi pengolahan data hujan
